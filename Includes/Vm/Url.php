...
class Vm_Url {
	...
	/**
	 * Rewrites a URL according the passed in rule class if URL rewriting is enabled
	...
	* Credit: stevenwebster http://ca3.php.net/manual/en/function.header.php#83448
	...
	*/
	...
	/**
	 * Gets the value of a parameter from a URL string
