...
* @license: MIT License
* Description: The DBOperations class is for performing data definition language (DDL) statements including creating and deleting
...
* 	This particular DBObject is for use with a MySQL PDO driver.
