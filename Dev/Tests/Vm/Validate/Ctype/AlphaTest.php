...
* @license: MIT License
* Description: Tests the Vm_Validate_Ctype_Alpha class
* Requirements: PHP 5.2 or higher
*/
class Tests_Vm_Validate_Ctype_AlphaTest extends Tests_Test {
	
	protected function testValidatesTrue(){
		$this->fixture = new Vm_Validate_Ctype_Alpha('JohnDoe');
	...
	protected function testDefaultError(){
		$this->fixture = new Vm_Validate_Ctype_Alpha('JohnDoe14');
	...
	protected function testCustomError(){
		$this->fixture = new Vm_Validate_Ctype_Alpha('JohnDoe14', 'What are you thinking?');
		return $this->assertEqual($this->fixture->getError(), 'What are you thinking?');
	}
	
	protected function testNumbersCauseError(){
		$this->fixture = new Vm_Validate_Ctype_Alpha('123514');
		return $this->assertFalse($this->fixture->validates());
	}
	
	protected function testCharactersCauseError(){
		$this->fixture = new Vm_Validate_Ctype_Alpha('!@#%><,`');
		return $this->assertFalse($this->fixture->validates());
	}
