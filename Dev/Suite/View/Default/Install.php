<div class="contentContainer firstContentContainer">
	...
	<div class="tabContent">
		...
		<div id="install">
			...
			<p>While you have successfully installed VM PHP Framework, you should install an app skeleton to accelerate 
			your development process. VM PHP Framework will automatically generate a basic app skeleton that includes a 
			bootstrap file, a configuration file, a basic MVC setup, a connection to the database, and a few other 
			utility files to get you started.</p>
			<p>After installation, additional tools will be made available in the Tools tab. Of course, you can modify 
			any of the files for your own purposes and you're welcome to skip installation if you need to setup your 
			app manually.</p>
			<?php echo $this->form; ?>
		</div>
		<div id="help">
			<h3 class="title">Installation Help</h3>
			<p>VM PHP Framework and the VM PHP Framework Development Suite rely heavily on the conditions listed on 
			the <i>Environment</i> tab. To ensure that your development process goes as smoothly as possible, please 
			install and enable all of the listed extensions and settings before	you begin to use the framework.</p>
			<p>Once you have installed an app skeleton, the install page will no longer be available in your menu. If 
			you need to access the environment check at a later time, you can also find it in the <i>Tools</i> page.</p>
